...
int main(int argc, char *argv[])
{
    ...
    as >> argstream::copyright("Newtons Fractal. Parameters marked with a start may be specified as a range (a:b), or just a value.\nFrames are generated by intpolating ranged values.");
